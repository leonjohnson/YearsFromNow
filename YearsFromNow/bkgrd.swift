...
class bkgrd: UIView {
    ...
    override func draw(_ rect: CGRect)
    {
        ...
        case APP_BACKGROUND_COLOURS.PURPLE_SUNSET:
            ...
            gradient = CGGradient(colorsSpace: CGColorSpaceCreateDeviceRGB(), colors: [gradientColor.cgColor, gradientColor2.cgColor, gradientColor3.cgColor], locations: [0, 0.5, 1])
        ...
        case APP_BACKGROUND_COLOURS.NEUTRAL_BLUE:
            ...
            gradient = CGGradient(colorsSpace: CGColorSpaceCreateDeviceRGB(), colors: [gradientColor.cgColor, gradientColor3.cgColor], locations: [0, 1])!
        ...
        case APP_BACKGROUND_COLOURS.CORN_YELLOW:
            ...
            gradient = CGGradient(colorsSpace: CGColorSpaceCreateDeviceRGB(), colors: [gradientColor3.cgColor, gradientColor.cgColor], locations: [0, 1])!
            gradientLine = [CGPoint(x: 0, y: 0), CGPoint(x: self.frame.maxX, y: self.frame.height)]
